...
function calculateScore(
  ...
  // Clicks — primary signal (normalised 0→30)
...
function _sortByRules(
  ...
  return [...items].sort(
    (a, b) => calculateScore(b, kitchenStatus, viewedItemIds) - calculateScore(a, kitchenStatus, viewedItemIds)
  );
}
