...
export default function QRPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--gm-bg)" }}>
      ...
      <header className="no-print" style={{ position: "relative", background: "transparent", borderBottom: "none", boxShadow: "none" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", padding: "24px 16px 16px", display: "flex", alignItems: "center", gap: 12 }}>
