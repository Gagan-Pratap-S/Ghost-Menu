  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--gm-bg)" }}>
      ...
      <header style={{ position: "relative", background: "transparent", borderBottom: "none", boxShadow: "none" }}>
        <div style={{ maxWidth: 520, margin: "0 auto", padding: "24px 16px 16px", display: "flex", alignItems: "center", gap: 12 }}>
      ...
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "24px 16px 120px", display: "flex", flexDirection: "column", gap: 16 }}>
        {restaurant?.id ? (
